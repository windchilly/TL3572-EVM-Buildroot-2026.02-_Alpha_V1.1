...
#if defined(OPENAMP_VDEV_ADDR) && defined(OPENAMP_VDEV_SIZE)
#define VDEV_START_ADDR         OPENAMP_VDEV_ADDR
#define SHM_SIZE               OPENAMP_VDEV_SIZE
#else
...
#define OS_OPENAMP_NOTIFY_HWI_NUM	MCS_NOTIFY_SGI_ID
